...
- Fixed an error in
  [`trimFileName()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/reference/trimFileName.md)
...
- Demography task received significant updates:
  - The [article for
    demography](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/demography.md)
...
- Mass Balance task received significant updates:
  - A dedicated [article for mass
    balance](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/mass-balance.md)
  ...
  - Mass balance plots can leverage user-defined settings from json
    ...
    article](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/mass-balance.md)
    ([\#1118](https://github.com/open-systems-pharmacology/ospsuite.reportingengine/issues/1118))
...
- Population workflows can use Monte Carlo sampling to handle ratio
  ...
  Workflows](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/pop-pk-parameters.html#ratio-comparison).
- [`Output`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/reference/Output.md)
...
- Excel template is up-to-date with the new features
  ...
  Template](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/excel-template.md)
- Mean and Population workflows can display a title/cover page at the
  ...
  report](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/add-title-page.md)
...
- Statistics in population workflow time profiles now use geometric mean
  ...
  and function
  [`setDefaultTimeProfileStatistics()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/reference/setDefaultTimeProfileStatistics.md)
...
- Qualification workflows are now available !
  ...
  - Qualification Workflows have their own
    [vignette](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/qualification-workflow.md)
    to help you start
