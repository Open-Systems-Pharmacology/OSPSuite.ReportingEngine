...
[`PopulationSimulationSet`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/dev/reference/PopulationSimulationSet.md).
...
the function
[`getDefaultDemographyXParameters()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/dev/reference/getDefaultDemographyXParameters.md).
...
- [`setDefaultAggregationBins()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/dev/reference/setDefaultAggregationBins.md)
- [`setDefaultAggregationFunctions()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/dev/reference/setDefaultAggregationFunctions.md)
- [`setDefaultAggregationLabels()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/dev/reference/setDefaultAggregationLabels.md)
