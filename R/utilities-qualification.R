...
#' @param plotList is a list of plots that is to be generated, all of the plot type `plotType`
#' @param plotType describes the type of the plots described in `plotList`
...
getScheduleOfPlotsOfType <- function(plotList, plotType) {
...
getScheduleOfPlots <- function(configurationPlan) {
  ...
  for (plotType in plotTypes) {
    plotList <- configurationPlan$plots[[plotType]]
    schedule <- rbind.data.frame(schedule, getScheduleOfPlotsOfType(plotList = plotList, plotType = plotType))
  }
  return(schedule)
}
