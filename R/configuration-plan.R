...
ConfigurationPlan <- R6::R6Class(
  ...
  public = list(
    ...
    getSectionPath = function(id) {
      validateIsIncludedRE(id, private$.sections$id, groupName = "'id' variable of sections")
    ...
    getObservedDataPath = function(id) {
      validateIsIncludedRE(id, private$.observedDataSets$id, groupName = "'id' variable of observedDataSets")
    ...
    getSimulationPath = function(project, simulation) {
      ...
      validateIsIncludedRE(project, private$.simulationMappings$project, groupName = "'project' variable of simulationMappings")
