...
-\>
[`ospsuite.reportingengine::SimulationTask`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/reference/SimulationTask.md)
-\> `CalculatePKParametersTask`
...
- [`ospsuite.reportingengine::SimulationTask$initialize()`](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/reference/SimulationTask.html#method-initialize)
