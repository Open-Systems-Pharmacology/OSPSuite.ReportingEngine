...
Then, you can run your workflow by running the R script (eg. using the function `source()`).
...
All of its content will be added as commented text (preceeded by `#` character) in first lines of your R script.
