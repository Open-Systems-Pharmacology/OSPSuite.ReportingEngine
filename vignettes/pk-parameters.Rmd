...
rmarkdown::render(workflow1$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow1$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow2$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow2$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow3$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow3$reportFilePath)))
```
</div>
...
knitr::raw_html(readLines(sub(".md", ".html", workflow4$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow5$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow5$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow6$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow6$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow7$reportFilePath)
```
...
knitr::raw_html(readLines(sub(".md", ".html", workflow7$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow8$reportFilePath)
```

The output report for Example 8 is shown below. 

<div class = "reportOutput">
```{r example 8 report, echo=FALSE, results='asis'}
knitr::raw_html(readLines(sub(".md", ".html", workflow8$reportFilePath)))
```
</div>
...
# Convert the markdown document into html
# Otherwise the root path is messed up and cannot print the report correctly
rmarkdown::render(workflow9$reportFilePath)
```

The output report for Example 9 is shown below. 

<div class = "reportOutput">
```{r example 9 report, echo=FALSE, results='asis'}
knitr::raw_html(readLines(sub(".md", ".html", workflow9$reportFilePath)))
```
</div>
