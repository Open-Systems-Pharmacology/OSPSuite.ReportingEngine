...
The creation of `MeanModelWorkflow` or `PopulationWorkflow` objects provides a structured environment with methods and properties that help in designing, runnning and reporting the evaluation of PBPK models developed on PK-Sim or/and Mobi.
...
These objects do not have to be instanciated by the user, they are created directly by the `Worklfow` object.
