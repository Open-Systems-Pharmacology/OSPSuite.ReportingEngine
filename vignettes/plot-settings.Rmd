...
Or it can be achieved, directly from a json file using the function `setDefaultThemeFromJson`, also illustrated below.
...
# Set current default Theme from json file
setDefaultThemeFromJson(jsonFile)
```
