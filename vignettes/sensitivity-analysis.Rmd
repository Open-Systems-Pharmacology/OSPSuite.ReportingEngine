...
With this setup, the sensitivity of PK parameters of `output1`, `output2` and `output3` will be analyzed for first population (given in `populationFile1`).  For the second population (given in `populationFile2`), sensitivity will only be analyzed for `output3`.
