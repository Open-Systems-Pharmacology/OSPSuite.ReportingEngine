...
[WorkflowInput.xlsx](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/templates/WorkflowInput.xlsx).
...
- If Study Design is defined as a separate csv file:
  ...
  - Include the path of the file in the cell corresponding to
    **StudyDesignLocation**  
    You can download and use the template
    [StudyDesign.csv](https://www.open-systems-pharmacology.org/OSPSuite.ReportingEngine/articles/templates/StudyDesign.csv)
    as reference
