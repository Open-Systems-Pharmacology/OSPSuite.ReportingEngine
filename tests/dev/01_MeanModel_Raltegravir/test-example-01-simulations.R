#--------------------------------------------------------------------------------------------------------#
# Advanced example 01: Set and run simulations of time profile and pk parameters for mean model workflow #
#--------------------------------------------------------------------------------------------------------#
...
myMeanWorkflow$activateTasks(c("simulate", "meanModelPKParameters"))
