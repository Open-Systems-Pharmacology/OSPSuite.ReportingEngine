...
# mm2 <- SimulationSet$new(simulationFile = simFilePath2, simulationSetName = "SET2")
# mmwf <- MeanModelWorkflow$new(simulationSets = list(mm1, mm2))
# mmwf$meanModelSensitivityAnalysis$settings$numberOfCores <- 2
# mmwf$runWorkflow()
...
# ppwf_par$simulatePopulation$settings$numberOfCores <- 6
# ppwf_par$populationSensitivityAnalysis$settings$variableParameterPaths <- c(simTree1$Organism$Bone$Volume$path, simTree1$Organism$`Plasma protein scale factor`$path)
# ppwf_par$populationSensitivityAnalysis$settings$numberOfCores <- 6
...
# ppwf_single_sa$simulatePopulation$settings$numberOfCores <- 1
# ppwf_single_sa$populationSensitivityAnalysis$settings$numberOfCores <- 1
...
# ppwf_par_sa$simulatePopulation$settings$numberOfCores <- 2
# ppwf_par_sa$populationSensitivityAnalysis$settings$numberOfCores <- 6
